...
var BiciUpload = function BiciUpload(props) {
  ...
  var uploadFileRequest = function uploadFileRequest(formData, token) {
    setUploading(true);
    (0, _util.fetchUpload)(props.action, formData, token).then(function (res) {
      console.log('----->>>>>', res);
    });
  };
  /**
  ...
  var beforeUpload = function beforeUpload(file, fileList) {
    ...
    var defaultSizeOverflowWarning = "\u6587\u4EF6\u5927\u5C0F\u8D85\u8FC7\u9650\u5236, \u6700\u5927\u652F\u6301".concat(defaultSize, "!");
  ...
  var onRemove = /*#__PURE__*/function () {
    var _ref3 = (0, _asyncToGenerator2.default)( /*#__PURE__*/(0, _regeneratorRuntime2.default)().mark(function _callee2(file) {
      var id;
  ...
  var onDownload = /*#__PURE__*/function () {
    var _ref4 = (0, _asyncToGenerator2.default)( /*#__PURE__*/(0, _regeneratorRuntime2.default)().mark(function _callee3(file) {
  ...
  return (0, _jsxRuntime.jsx)(_configProvider.default, {
    prefixCls: "mart",
    children: (0, _jsxRuntime.jsx)(_upload.default, (0, _objectSpread2.default)((0, _objectSpread2.default)({}, uploadProps), {}, {
      children: props.children
    }))
  });
};

var _default = BiciUpload;
