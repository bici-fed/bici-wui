...
var BaseRequest = /*#__PURE__*/function () {
  ...
  function BaseRequest(config) {
    ...
    (0, _classCallCheck2.default)(this, BaseRequest);
    this.instance = void 0;
    this.interceptorsObj = void 0;
    this.cancelRequestSourceList = void 0;
    this.requestUrlList = void 0;
    var axiosConfig = (0, _objectSpread2.default)({}, (0, _lodash.omit)(config, ['nterceptors']));
    this.instance = _axios.default.create(axiosConfig);
  ...
  (0, _createClass2.default)(BaseRequest, [{
    key: "request",
    value: function request(config) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        if (url) {
          ...
          config.cancelToken = new _axios.default.CancelToken(function (c) {
            var _this$cancelRequestSo;

            (_this$cancelRequestSo = _this.cancelRequestSourceList) === null || _this$cancelRequestSo === void 0 ? void 0 : _this$cancelRequestSo.push((0, _defineProperty2.default)({}, url, c));
          });
        }
